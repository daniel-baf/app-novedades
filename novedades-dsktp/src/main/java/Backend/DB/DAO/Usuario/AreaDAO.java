...
public class AreaDAO {
     ...
     */
    public ArrayList<Area> select() throws CustomException {
    ...
    private Area getAreaFromRs(ResultSet rs) throws SQLException {
        return new Area(rs.getString("area"));
    }
}
